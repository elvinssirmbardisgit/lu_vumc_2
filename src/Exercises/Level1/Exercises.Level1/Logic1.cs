...
namespace Exercises.Level1
{
    ...
    public class Logic1
    {
        ...
        {
            int speedUpdated = speed;
            if (isBirthday == true)
            {
                speedUpdated = speed - 5;
            }
            if(speedUpdated <= 60)
            {
                return 0;
            }
            if(speedUpdated >= 61 && speedUpdated <= 80)
            {
                return 1;
            }
            return 2;
        ...
        {
            string charFirst = str.Substring(0, 1);
            string charLast = str.Substring(str.Length - 1);

            if (charFirst == "f" && charLast == "b")
            {
                return "FizzBuzz";
            }
            if (charFirst == "f")
